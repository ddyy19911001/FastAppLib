...
public abstract class BaseTabViewActivity extends SuperBaseActivity {
    ...
    public static class TableBuilder{
         ...
         * @return
         */
        private TabUtils createTable(BaseTabViewActivity activity){
    ...
    public TabUtils makeTableLayout() {
        ...
        if(bundles.size()>0&&bundles.size()==names.length) {
            utils.initPageFg(bundles, hmTabLayout, tabViewPager, this, names, getSupportFragmentManager(), R.layout.hm_custom_tab_text, R.id.tv_tab);
        }else{
            utils.initPageFg(hmTabLayout, tabViewPager, this, names, getSupportFragmentManager(), R.layout.hm_custom_tab_text, R.id.tv_tab);
        }
