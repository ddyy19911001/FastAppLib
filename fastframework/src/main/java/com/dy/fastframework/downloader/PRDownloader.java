...
package com.dy.fastframework.downloader;
...
import com.dy.fastframework.downloader.request.DownloadRequestBuilder;
...
public class PRDownloader {
     ...
     */
    public static boolean cancel(int downloadId) {
        return DownloadRequestQueue.getInstance().cancel(downloadId);
    }
