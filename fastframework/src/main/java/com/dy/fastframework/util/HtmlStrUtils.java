...
public class HtmlStrUtils {
     ...
     * @return
     */
    public static Spanned getHtmlStr(Context context, TextView tv, String content){
        if(MyUtils.isEmpty(content)){
            return null;
        }
        MyImageGetter myImageGetter = new MyImageGetter(context, tv);
        return Html.fromHtml(content,myImageGetter,null);
    }
